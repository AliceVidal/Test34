 ...
 */
final class Version20210312133124 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_pack (user_id INT NOT NULL, pack_id INT NOT NULL, INDEX IDX_ED5F12EAA76ED395 (user_id), INDEX IDX_ED5F12EA1919B217 (pack_id), PRIMARY KEY(user_id, pack_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
